...
var _ wallet.WalletRepository = &SQLiteRepository{}
...
func (repo *SQLiteRepository) AddWallet(wallet *wallet.Wallet) error {
	insertQuery := `
...
func (repo *SQLiteRepository) GetAllWallets() ([]wallet.Wallet, error) {
	selectQuery := `
